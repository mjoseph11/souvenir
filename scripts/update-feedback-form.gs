/**
 * SGMOC Golden Jubilee Souvenir — Update Existing Feedback Form
 *
 * This script edits the EXISTING Google Form in place.
 * It clears all questions and rebuilds them — the share URL stays the same.
 *
 * HOW TO RUN:
 * 1. Go to script.google.com → New project
 * 2. Paste this entire file
 * 3. Click Run → updateSouvenirFeedbackForm
...
function updateSouvenirFeedbackForm() {
  ...
  form.addParagraphTextItem()
    ...
    .setHelpText('Title, name, photo, message text')
    .setRequired(false);

  form.addParagraphTextItem()
    .setTitle('Any corrections to the Vicar\'s message page (Page 4)?')
    .setHelpText('Title, name (Rev. Fr. Shibu Venad Mathai), photo, message text')
    .setRequired(false);
  ...
  form.addParagraphTextItem()
    ...
    .setHelpText('Current: Principal – Dr. Sherrin Kurien, Dean – Dr. Renny Thomas, Registrar – Dr. Ajeesh Cherian')
    .setRequired(false);

  form.addParagraphTextItem()
    .setTitle('Sunday School — what additional content should be included?')
    .setHelpText('e.g. enrollment numbers, grade structure, key programs, notable alumni, history')
    .setRequired(false);
  ...
  form.addParagraphTextItem()
    ...
    .setHelpText('Current: President – Rev. Fr. Shibu Venad Mathai (Vicar). Vice President, Secretary, Treasurer names needed.')
    .setRequired(false);
  ...
  form.addParagraphTextItem()
    ...
    .setHelpText('Please confirm 2026 Vice President, Secretary, Joint Secretary, Treasurer names')
    .setRequired(false);
  ...
  form.addSectionHeaderItem()
    .setTitle('GROW (Women\'s Ministry)')
    .setHelpText('');

  form.addParagraphTextItem()
    .setTitle('GROW — corrections to leadership names or titles?')
    .setHelpText('Current: Leader – Soumia Varghese. Secretary and Treasurer names needed.')
    .setRequired(false);
  ...
  form.addParagraphTextItem()
    ...
    .setHelpText('Current: Secretary – Reny Biju, Joint Secretary – Christeena Poovathoor, Treasurer – Mercy Varkey, Central Committee – Annamma Samuel')
    .setRequired(false);
